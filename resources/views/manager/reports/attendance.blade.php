...
<div class="min-h-screen bg-slate-50 py-10 px-4">
    <div class="max-w-6xl mx-auto space-y-6">
        <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <div>
                <h1 class="text-2xl font-semibold text-slate-900">Laporan Kehadiran Tim</h1>
                <p class="mt-1 text-sm text-slate-500">Filter dan unduh data kehadiran anggota tim Anda.</p>
            </div>
        </div>
