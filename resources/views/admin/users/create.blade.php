    ...
    <div class="max-w-3xl mx-auto space-y-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-slate-500">Lengkapi data berikut untuk membuat akun baru.</p>
            </div>
            ...
            <x-ui-card-content>
                <form method="POST" action="{{ route('admin.users.store') }}" class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <input id="name" type="text" name="name" value="{{ old('name') }}" class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-200">
                        @error('name')
                    ...
                    <div class="space-y-2">
                        ...
                        <input id="email" type="email" name="email" value="{{ old('email') }}" class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-200">
                        @error('email')
                            <p class="text-sm text-rose-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        <div class="space-y-2">
                            ...
                            <input id="employee_id" type="text" name="employee_id" value="{{ old('employee_id') }}" class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-200">
                            @error('employee_id')
                                <p class="text-sm text-rose-600">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="space-y-2">
                            ...
                            <input id="phone" type="text" name="phone" value="{{ old('phone') }}" class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-200">
                            @error('phone')
                                <p class="text-sm text-rose-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        <div class="space-y-2">
                            ...
                            <input id="password" type="password" name="password" class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-200">
                            @error('password')
                                <p class="text-sm text-rose-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center gap-3">
                            <label class="inline-flex items-center gap-2">
                                <input type="radio" name="is_active" value="1" class="h-4 w-4 border-slate-300 text-primary-600 focus:ring-primary-500" @checked(old('is_active', '1') === '1')>
                                <span class="text-sm text-slate-700">Aktif</span>
                            </label>
                            <label class="inline-flex items-center gap-2">
                                <input type="radio" name="is_active" value="0" class="h-4 w-4 border-slate-300 text-primary-600 focus:ring-primary-500" @checked(old('is_active') === '0')>
