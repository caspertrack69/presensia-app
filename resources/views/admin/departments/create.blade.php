                ...
                <form method="POST" action="{{ route('admin.departments.store') }}" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        <div class="space-y-2">
                            ...
                            <input id="code" type="text" name="code" value="{{ old('code') }}" class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-200">
                            @error('code')
                                <p class="text-sm text-rose-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea id="description" name="description" rows="4" class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-200">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="text-sm text-rose-600">{{ $message }}</p>
                        @enderror
                    </div>
